...
CAPABILITIES = [
    ...
    ("vision", "multimodal", "Describe or analyze images (photos, screenshots).", ["model"]),
    ...
    ("device", "wearable", "Connect to the XIAO wearable over wifi/bt/cable.", ["device"]),
    ("brain", "memory", "Read/write the Cyclops note brain (tasks/ideas/decisions).", []),
