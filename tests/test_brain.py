...
from brain.protocol import MSG, decode_frame, encode
...
def test_extractor_categories():
    notes = extract(
        "Remind me to send the invoice by friday. We decided to ship the MVP next week. Idea: add a vibration alert."
    )
