...
class FakeSession:
    ...
    def __init__(self, response):
        ...
        self.response = response if isinstance(response, FakeResp) else FakeResp(response)
        self.last = None
